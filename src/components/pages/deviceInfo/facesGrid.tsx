...
const facesGrid = ({ deviceId, Name, R1Id, R2Id, R3Id, R4Id, }: FacesGridProps) => {
    const faces = [
        {
            id: R1Id || "unique-id-1",
            emotion: "Really Sad",
    ...
    return (
        ...
        <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between p-4 bg-secundary/50 text-text rounded-default shadow-sm">
